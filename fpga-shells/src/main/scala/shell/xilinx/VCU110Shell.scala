...
package sifive.fpgashells.shell.xilinx.vcu110shell
...
import sifive.fpgashells.devices.xilinx.xilinxvcu110mig._
import sifive.fpgashells.ip.xilinx.{IBUFDS, PowerOnResetFPGAOnly, sdio_spi_bridge, vcu110_sys_clock_mmcm0,
                                    vcu110_sys_clock_mmcm1, vcu110reset}

//-------------------------------------------------------------------------
// VCU110Shell
//-------------------------------------------------------------------------

trait HasDDR3 { this: VCU110Shell =>
  
  require(!p.lift(MemoryXilinxDDRKey).isEmpty)
  val hmc = IO(new XilinxVCU110MIGPads(p(MemoryXilinxDDRKey)))
  
  def connectMIG(dut: HasMemoryXilinxVCU110MIGModuleImp): Unit = {
    // Clock & Reset
    dut.xilinxvcu110mig.c0_sys_clk_i := sys_clock.asUInt
    mig_clock                    := dut.xilinxvcu110mig.c0_ddr4_ui_clk
    mig_sys_reset                := dut.xilinxvcu110mig.c0_ddr4_ui_clk_sync_rst
    dut.xilinxvcu110mig.c0_ddr4_aresetn   := mig_resetn
    dut.xilinxvcu110mig.sys_rst   := sys_reset

    hmc <> dut.xilinxvcu110mig
  }
}

abstract class VCU110Shell(implicit val p: Parameters) extends RawModule {
  ...
  //25MHz and multiples
  val vcu110_sys_clock_mmcm0 = Module(new vcu110_sys_clock_mmcm0)
  vcu110_sys_clock_mmcm0.io.clk_in1 := sys_clock.asUInt
  vcu110_sys_clock_mmcm0.io.reset   := reset
  val clk50                  = vcu110_sys_clock_mmcm0.io.clk_out1
  //val clk25                = vcu110_sys_clock_mmcm0.io.clk_out2
  //val clk37_5              = vcu110_sys_clock_mmcm0.io.clk_out3
  //val clk50                = vcu110_sys_clock_mmcm0.io.clk_out4
  //val clk100               = vcu110_sys_clock_mmcm0.io.clk_out5
  //val clk150               = vcu110_sys_clock_mmcm0.io.clk_out6
  //val clk75                = vcu110_sys_clock_mmcm0.io.clk_out7
  val vcu110_sys_clock_mmcm0_locked = vcu110_sys_clock_mmcm0.io.locked

  //65MHz and multiples
  //val vcu110_sys_clock_mmcm1 = Module(new vcu110_sys_clock_mmcm1)
  //vcu110_sys_clock_mmcm1.io.clk_in1 := sys_clock.asUInt
  //vcu110_sys_clock_mmcm1.io.reset   := reset
  //val clk32_5              = vcu110_sys_clock_mmcm1.io.clk_out1
  //val clk65                = vcu110_sys_clock_mmcm1.io.clk_out2
  //val vcu110_sys_clock_mmcm1_locked = vcu110_sys_clock_mmcm1.io.locked
  ...
  do_reset             := !mig_mmcm_locked || !mmcm_lock_pcie || mig_sys_reset || !vcu110_sys_clock_mmcm0_locked 
  ...
  val safe_reset = Module(new vcu110reset)
