...
package sifive.fpgashells.shell.xilinx.zcu102shell
...
import sifive.fpgashells.ip.xilinx.{IBUFDS, BUFG, PowerOnResetFPGAOnly, sdio_spi_bridge, zcu102_sys_clock_mmcm0,
                                    zcu102_sys_clock_mmcm1, zcu102reset}
...
// should be ddr4
trait HasDDR3 { this: ZCU102Shell =>
  
  require(!p.lift(MemoryXilinxDDRKey).isEmpty)
  val ddr = IO(new XilinxZCU102MIGPads(p(MemoryXilinxDDRKey)))
  
  def connectMIG(dut: HasMemoryXilinxZCU102MIGModuleImp): Unit = {
    // Clock & Reset
    dut.xilinxzcu102mig.c0_sys_clk_i := sys_clock.asUInt
    mig_clock                    := dut.xilinxzcu102mig.c0_ddr4_ui_clk
    mig_sys_reset                := dut.xilinxzcu102mig.c0_ddr4_ui_clk_sync_rst
    dut.xilinxzcu102mig.c0_ddr4_aresetn   := mig_resetn
    dut.xilinxzcu102mig.sys_rst   := sys_reset

    ddr <> dut.xilinxzcu102mig
  }
}

abstract class ZCU102Shell(implicit val p: Parameters) extends RawModule {
  ...
  val BUFG_inst = Module(new BUFG)
  BUFG_inst.io.I := sys_clk_ibufds.io.O
  //-----------------------------------------------------------------------
  // System clock and reset
  //-----------------------------------------------------------------------

  // Clock that drives the clock generator and the MIG
  sys_clock := BUFG_inst.io.O
  ...
  //60MHz and multiples
  val zcu102_sys_clock_mmcm0 = Module(new zcu102_sys_clock_mmcm0)
  zcu102_sys_clock_mmcm0.io.clk_in1 := sys_clock.asUInt
  zcu102_sys_clock_mmcm0.io.reset   := reset
  val clk60              = zcu102_sys_clock_mmcm0.io.clk_out1
  //val clk25                = zcu102_sys_clock_mmcm0.io.clk_out2
  //val clk37_5              = zcu102_sys_clock_mmcm0.io.clk_out3
  //val clk50                = zcu102_sys_clock_mmcm0.io.clk_out4
  //val clk100               = zcu102_sys_clock_mmcm0.io.clk_out5
  //val clk150               = zcu102_sys_clock_mmcm0.io.clk_out6
  //val clk75                = zcu102_sys_clock_mmcm0.io.clk_out7
  val zcu102_sys_clock_mmcm0_locked = zcu102_sys_clock_mmcm0.io.locked

  //65MHz and multiples
  //val zcu102_sys_clock_mmcm1 = Module(new zcu102_sys_clock_mmcm1)
  //zcu102_sys_clock_mmcm1.io.clk_in1 := sys_clock.asUInt
  //zcu102_sys_clock_mmcm1.io.reset   := reset
  //val clk32_5              = zcu102_sys_clock_mmcm1.io.clk_out1
  //val clk65                = zcu102_sys_clock_mmcm1.io.clk_out2
  //val zcu102_sys_clock_mmcm1_locked = zcu102_sys_clock_mmcm1.io.locked
  ...
  do_reset             := !mig_mmcm_locked || !mmcm_lock_pcie || mig_sys_reset || !zcu102_sys_clock_mmcm0_locked
  ...
  val safe_reset = Module(new zcu102reset)
