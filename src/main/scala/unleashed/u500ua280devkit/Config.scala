...
import sifive.fpgashells.devices.xilinx.xilinxua280mig.{MemoryXilinxDDRKey,XilinxUA280MIGParams}

// Default FreedomUVC707Config
class FreedomUA280Config extends Config(
  //new WithJtagDTM            ++
...
class U500UA280DevKitPeripherals extends Config((site, here, up) => {
...
class U500UA280DevKitConfig extends Config(
  new WithNExtTopInterrupts(0)   ++
  new U500UA280DevKitPeripherals ++
  new FreedomUA280Config().alter((site,here,up) => {
    ...
    case MemoryXilinxDDRKey => XilinxUA280MIGParams(address = Seq(AddressSet(0x80000000L,0x80000000L-1))) //2GB
